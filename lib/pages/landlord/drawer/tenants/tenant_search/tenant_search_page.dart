...
class TenantsSearchScreen extends StatefulWidget {
  final bool? isBottomNav;

  const TenantsSearchScreen({super.key, this.isBottomNav});

  @override
  State<TenantsSearchScreen> createState() => _TenantsSearchScreenState();
}

class _TenantsSearchScreenState extends State<TenantsSearchScreen> {
  @override
  void initState() {
              ...
              child: Column(
                ...
                children: [
                  ...
                  provider.tenantModel?.data?.list != null
                      ? SearchTenantList(provider: provider)
