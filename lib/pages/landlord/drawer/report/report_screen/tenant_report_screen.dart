...
class TenantReportScreen extends StatelessWidget {
  const TenantReportScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: const CustomAppBar(appBarName: 'Tenant report'),
      ),
      body: Stack(
        children: [
          Positioned(
          ...
          SingleChildScrollView(
            child: Padding(
              ...
              child: provider.tenants.isNotEmpty ? provider.tenants != null
                  ? Column(
                      ...
                      children: [
                        ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final data = provider.tenants[index];
                              return Container(
