class ApiProvider {
  ...
  static String registration = '$baseUrl/public/v1/register';
  ...
  static String paymentReportList = '$baseUrl/private/v1/reports/payment-report';
  static String tenantReportList = '$baseUrl/private/v1/reports/tenant-report';
